    ...
    <div class="space-y-6 p-6">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="bg-white shadow-lg rounded-lg border border-orange-200 hover:shadow-xl transition-shadow duration-300">
                <div class="p-6 flex items-center">
                    <div class="flex-shrink-0 bg-orange-500 rounded-lg p-3">
                        <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M9 17v-6a2 2 0 012-2h6m2 8V7a2 2 0 00-2-2h-5.172a2 2 0 01-1.414-.586L9 2.414A2 2 0 007.586 2H5a2 2 0 00-2 2v11a2 2 0 002 2h4" />
                        </svg>
                    </div>
                    <div class="ml-6">
                        <div class="text-sm font-medium text-orange-700">Total Employees</div>
                        <div class="text-2xl font-bold text-orange-900">{{ App\Models\Employee::count() }}</div>
                    </div>
                </div>
                <div class="bg-orange-50 px-6 py-4">
                    <a href="#" class="text-orange-600 hover:text-orange-800 font-medium text-sm transition-colors duration-200">View all</a>
            ...
            <div class="bg-white shadow-lg rounded-lg border border-orange-200 hover:shadow-xl transition-shadow duration-300">
                <div class="p-6 flex items-center">
                    ...
                    <div class="ml-6">
                        <div class="text-sm font-medium text-orange-700">Total Managers</div>
                        <div class="text-2xl font-bold text-orange-900">{{ App\Models\User::role('manager')->count() }}</div>
                    </div>
                </div>
                <div class="bg-orange-50 px-6 py-4">
                    <a href="#" class="text-orange-600 hover:text-orange-800 font-medium text-sm transition-colors duration-200">View all</a>
        ...
        <div class="mt-8">
            <div class="bg-white shadow-lg rounded-lg border border-orange-200 p-6">
                <h3 class="text-lg font-semibold text-orange-900 mb-4">All Employees & Managers</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-orange-200">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider">Role</th>
                        ...
                        @foreach ($employees as $employee)
                            <tr class="hover:bg-orange-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-orange-700">{{ $employee->user->roles->first()->name ?? 'N/A' }}</td>
